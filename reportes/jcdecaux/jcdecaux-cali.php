        ...
        <div class="container">
            <div class="row">
               <div class="scans col-md-6 col-lg-6">
                        ...
                        <h4 class="section-heading">EVOLUCIÓN SEMANAL DE SCANS Y VIEWS <span class="ciudad">(Cali)</span></h4>
                    </div>
                    <div>
    ...
    <section id="historial" class="bg-light-gray">
        <div class="container">
            ...
            <div class="row text-center">
                ...
                WHERE historial.estatus = 1 and id_ciudad = 3 and id_cliente = 2 ORDER BY historial.id DESC';
